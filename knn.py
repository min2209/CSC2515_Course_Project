...
def main():
    ...
    #extra_train = gen_input.read_data_sets(DATA_PATH + "extra_32x32.mat", [1,0,0])
    Xtr = train.train.images #+ extra_train.train.images
    Ytr = train.train.labels #+ extra_train.train.labels
    ...
    for reduced_dimension in REDUCED_DIMENSIONS:
        ...
        print "Done projecting data to PCA with dimensions = ", REDUCED_DIMENSIONS
        ...
        plt.savefig('./plots/knn/sift.png', bbox_inches='tight')
